...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    if (this.$route.query.resourceId) {
      this.load(this.$route.query.resourceId).then(function (detail) {
        __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_entries___default()(detail.meta).forEach(function (entry) {
  ...
  methods: {
    addMetaHandler: function addMetaHandler(key, value) {
      console.log(key);
      this.metas.push({
        key: key || '',
        value: value || ''
    ...
    deleteMetaHandler: function deleteMetaHandler(index) {
      this.metas.splice(index, 1);
    },
    load: function load(param) {
      var _this = this;

      return this.$services.resource.get(param || {}).then(function (res) {
        return _this.detail = res.getData();
      }).catch(function (err) {
        _this.$message.error(err.response.errorMsg || err);
      });
    },
    resolveMeta: function resolveMeta() {
      var _this2 = this;

      var metas = this.metas;
      this.detail.meta = {};
      metas.forEach(function (meta) {
        _this2.detail.meta[meta.key] = meta.value;
      });
    },
    updatePageBuildHandler: function updatePageBuildHandler() {
    ...
    saveHandler: function saveHandler(form) {
      var _this3 = this;

      var mutableKeys = ['resourceName', 'meta'];
      var data = {};

      this.resolveMeta();
      mutableKeys.forEach(function (k) {
        data[k] = _this3.detail[k];
      });

      // data.meta = JSON.stringify(data.meta)
      this.$services.resource.put(this.detail.resourceId, data).then(function (res) {
...
/* harmony default export */ __webpack_exports__["a"] = (RESOURCE_TYPES);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',[_c('el-form',{ref:"detail",staticClass:"resource-detail",attrs:{"model":_vm.detail,"rules":_vm.rules,"label-width":"100px"}},[_c('el-form-item',{attrs:{"label":"resourceId","prop":"resourceId"}},[_c('el-input',{attrs:{"disabled":""},model:{value:(_vm.detail.resourceId),callback:function ($$v) {_vm.$set(_vm.detail, "resourceId", $$v)},expression:"detail.resourceId"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"resourceType","prop":"resourceType"}},[_c('el-input',{attrs:{"disabled":""},model:{value:(_vm.detail.resourceId),callback:function ($$v) {_vm.$set(_vm.detail, "resourceId", $$v)},expression:"detail.resourceId"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"resourceUrl","prop":"resourceUrl"}},[_c('el-input',{attrs:{"disabled":""},model:{value:(_vm.detail.resourceUrl),callback:function ($$v) {_vm.$set(_vm.detail, "resourceUrl", $$v)},expression:"detail.resourceUrl"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"resourceType","prop":"resourceType"}},[_c('el-input',{attrs:{"disabled":""},model:{value:(_vm.detail.resourceType),callback:function ($$v) {_vm.$set(_vm.detail, "resourceType", $$v)},expression:"detail.resourceType"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"resourceName","prop":"resourceName","required":""}},[_c('el-input',{model:{value:(_vm.detail.resourceName),callback:function ($$v) {_vm.$set(_vm.detail, "resourceName", $$v)},expression:"detail.resourceName"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"mimeType","prop":"mimeType"}},[_c('el-input',{attrs:{"disabled":""},model:{value:(_vm.detail.mimeType),callback:function ($$v) {_vm.$set(_vm.detail, "mimeType", $$v)},expression:"detail.mimeType"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"createDate","prop":"createDate"}},[_c('el-input',{attrs:{"disabled":""},model:{value:(_vm.detail.createDate),callback:function ($$v) {_vm.$set(_vm.detail, "createDate", $$v)},expression:"detail.createDate"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"meta信息","prop":"meta"}},[_vm._l((_vm.detail.systemMeta),function(val,key){return [_c('el-form-item',{staticClass:"meta-detail-item",attrs:{"label":key}},[_c('el-input',{attrs:{"value":typeof val === 'string'?val:JSON.stringify(val),"disabled":""}})],1)]}),_vm._v(" "),_vm._l((_vm.metas),function(item,index){return [_c('el-row',{staticClass:"meta-item",attrs:{"gutter":5}},[_c('el-col',{attrs:{"span":5}},[_c('el-input',{attrs:{"placeholder":"key只能由字母和_组成"},model:{value:(item.key),callback:function ($$v) {_vm.$set(item, "key", $$v)},expression:"item.key"}})],1),_vm._v(" "),_c('el-col',{attrs:{"span":15}},[_c('el-input',{attrs:{"placeholder":"value"},model:{value:(item.value),callback:function ($$v) {_vm.$set(item, "value", $$v)},expression:"item.value"}})],1),_vm._v(" "),_c('el-col',{attrs:{"span":2}},[_c('el-button',{on:{"click":function($event){_vm.deleteMetaHandler(index)}}},[_vm._v("delete")])],1)],1)]}),_vm._v(" "),_c('el-button',{on:{"click":function($event){_vm.addMetaHandler()}}},[_vm._v("add meta")])],2),_vm._v(" "),_c('el-form-item',{attrs:{"label":"file"}},[_c('div',{staticClass:"upload-wrapper"},[_c('el-upload',{ref:"upload",staticClass:"upload-container",attrs:{"drag":"","headers":_vm.uploader.headers,"data":_vm.uploader.data,"action":'/v1/resources/updateResourceContext/'+_vm.detail.resourceId,"on-success":_vm.successHandler,"auto-upload":false}},[_c('i',{staticClass:"el-icon-upload"}),_vm._v(" "),_c('div',{staticClass:"el-upload__text"},[_vm._v("将文件拖到此处，或"),_c('em',[_vm._v("点击上传")])]),_vm._v(" "),_c('div',{staticClass:"el-upload__tip",attrs:{"slot":"tip"},slot:"tip"},[_vm._v("上传文件不超过256MB")])])],1)]),_vm._v(" "),_c('el-form-item',{staticClass:"btns"},[_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.saveHandler('detail')}}},[_vm._v("保存")]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.updatePageBuildHandler('detail')}}},[_vm._v("更新资源文件")]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":function($event){_vm.backToList()}}},[_vm._v("返回")])],1)],1)],1)}
var staticRenderFns = []
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pagebuilder_vue__ = __webpack_require__("Gc4p");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3522a7c0_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pagebuilder_vue__ = __webpack_require__("NINa");
function injectStyle (ssrContext) {
  __webpack_require__("sprB")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-3522a7c0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pagebuilder_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3522a7c0_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pagebuilder_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// load the styles
var content = __webpack_require__("mNrl");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("5bd1e43f", content, true);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.resource)?_c('div',{staticClass:"resource-detail"},[_c('h3',[_vm._v(_vm._s(_vm.resource.resourceName))])]):_vm._e(),_vm._v(" "),_c('el-input',{staticClass:"gap",attrs:{"spellcheck":"false","type":"textarea","rows":15,"placeholder":"请输入policy"},model:{value:(_vm.policyText),callback:function ($$v) {_vm.policyText=$$v},expression:"policyText"}}),_vm._v(" "),_c('el-button',{attrs:{"type":"primary","loading":_vm.validateLoading},on:{"click":_vm.validate}},[_vm._v("格式校验")]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary","loading":_vm.submitLoading},on:{"click":_vm.submit}},[_vm._v("提交")])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pagebuilder_vue__ = __webpack_require__("5i1m");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__resource_types__ = __webpack_require__("3UoX");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  components: { PageBuilder: __WEBPACK_IMPORTED_MODULE_3__pagebuilder_vue__["a" /* default */] },
  data: function data() {
    var _this = this;

    var validateResourceType = function validateResourceType(rule, value, callback) {
      var NAME_REG = /^[a-z][0-9a-z_]{3,19}[^_]$/;
      console.log(value);
    ...
    var validateWidgetName = function validateWidgetName(rule, value, callback) {
      //格式为freelog-xxx-yyyy，最少4个字符
      var NAME_REG = /^freelog-[a-z0-9._-]{4,15}-[a-z0-9._-]{4,64}$/;
      if (_this.formData.resourceType === __WEBPACK_IMPORTED_MODULE_4__resource_types__["a" /* default */].widget && !NAME_REG.test(value)) {
    ...
    return {
      ResourceTypes: __WEBPACK_IMPORTED_MODULE_4__resource_types__["a" /* default */],
      rules: {
        resourceName: [{ required: true, message: '请输入资源名称', trigger: 'blur' }],
        widgetName: [{ validator: validateWidgetName, trigger: 'blur' }],
        resourceType: [{ required: true, message: '请选择资源类型', trigger: 'blur' }, { validator: validateResourceType, trigger: 'blur' }]
      },
      options: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(__WEBPACK_IMPORTED_MODULE_4__resource_types__["a" /* default */]).map(function (k) {
        return { label: k, value: __WEBPACK_IMPORTED_MODULE_4__resource_types__["a" /* default */][k] };
      }),

      formData: {
        resourceType: __WEBPACK_IMPORTED_MODULE_4__resource_types__["a" /* default */].pageBuild || '',
        resourceName: '',
        widgetName: '',
        metas: []
      },
  ...
  methods: {
    addMetaHandler: function addMetaHandler() {
    ...
    successHandler: function successHandler(res, file) {
      var _this2 = this;
      ...
      if (res.ret != 0) {
        ...
        setTimeout(function () {
          _this2.$router.push({ path: '/resource/policy/create', query: { resourceId: res.data.resourceId } });
        }, 5e2);
      }
    },
    packDataForpage_build: function packDataForpage_build($uploader) {
      var pageBuilder = this.$refs.pageBuilder;
      $uploader.handleStart(pageBuilder.getPageBuildFile());
    },
    packDataForwidget: function packDataForwidget($uploader) {
      $uploader.data.meta.widgetName = this.formData.widgetName;
    },
    packUploadData: function packUploadData() {
      var $uploader = this.$refs.upload;
      var uploadData = $uploader.data;
      var formData = this.formData;
      var resType = formData.resourceType;
      var fnName = 'packDataFor' + resType;

      __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(formData).forEach(function (key) {
      ...
      uploadData.meta = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(uploadData.meta);
    },
    packMetaData: function packMetaData() {
      var metas = {};
      this.formData.metas.forEach(function (meta) {
        meta.key && (metas[meta.key] = meta.value);
      });

      return metas;
    },
    submitUpload: function submitUpload(formName) {
      var _this3 = this;

      var $uploader = this.$refs.upload;

      this.$refs[formName].validate(function (valid, err) {
        if (valid) {
          _this3.packUploadData();
          //检查是否有上传文件
          if ($uploader.uploadFiles.length > 0) {
            $uploader.submit();
          } else {
            _this3.$message.error('无上传文件');
          }
        } else {
          _this3.$message.error('数据验证有误');
          return false;
        }
      });
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pagebuilder__ = __webpack_require__("aFp7");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0__pagebuilder__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__("oeXp");
//
//
//
//
...
// module
exports.push([module.i, ".meta-item[data-v-cc5d679c]{margin-bottom:6px}.resource-detail[data-v-cc5d679c]{width:80%;margin:auto}.resource-detail .btns[data-v-cc5d679c]{text-align:center}.meta-detail-item[data-v-cc5d679c]{margin-bottom:9px}", "", {"version":3,"sources":["/Users/daizecheng/workplace/freelog/console/client/src/views/resource/edit/index.vue"],"names":[],"mappings":"AACA,4BACE,iBAAmB,CACpB,AACD,kCACE,UAAW,AACX,WAAa,CACd,AACD,wCACE,iBAAmB,CACpB,AACD,mCACE,iBAAmB,CACpB","file":"index.vue","sourcesContent":["\n.meta-item[data-v-cc5d679c] {\n  margin-bottom: 6px;\n}\n.resource-detail[data-v-cc5d679c] {\n  width: 80%;\n  margin: auto;\n}\n.resource-detail .btns[data-v-cc5d679c] {\n  text-align: center;\n}\n.meta-detail-item[data-v-cc5d679c] {\n  margin-bottom: 9px;\n}\n"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__("SamV");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_12d310b3_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__("WW66");
function injectStyle (ssrContext) {
  __webpack_require__("MpSZ")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-12d310b3"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_12d310b3_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
( function( window, factory ) {
  ...
  if ( true ) {
    // AMD
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [
        __webpack_require__("SdC7"),
        __webpack_require__("1ftd")
...
// load the styles
var content = __webpack_require__("eRzV");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("99472422", content, true);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"create-resource-wrapper"},[_c('el-form',{ref:"createForm",attrs:{"model":_vm.formData,"label-width":"100px","rules":_vm.rules}},[_c('el-form-item',{attrs:{"label":"资源类型","prop":"resourceType","required":""}},[_c('el-select',{staticStyle:{"width":"300px"},attrs:{"allow-create":"","filterable":"","placeholder":"只能包含大小写字母、_和-，长度4~40"},model:{value:(_vm.formData.resourceType),callback:function ($$v) {_vm.$set(_vm.formData, "resourceType", $$v)},expression:"formData.resourceType"}},_vm._l((_vm.options),function(item){return _c('el-option',{key:item.value,attrs:{"label":item.label,"value":item.value}})}))],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"资源名称","prop":"resourceName","required":""}},[_c('el-input',{model:{value:(_vm.formData.resourceName),callback:function ($$v) {_vm.$set(_vm.formData, "resourceName", $$v)},expression:"formData.resourceName"}})],1),_vm._v(" "),_c('el-form-item',{directives:[{name:"show",rawName:"v-show",value:(_vm.formData.resourceType === _vm.ResourceTypes.widget),expression:"formData.resourceType === ResourceTypes.widget"}],attrs:{"label":"widgetName","prop":"widgetName"}},[_c('el-input',{attrs:{"placeholder":"保持与web component中的自定义标签名一致"},model:{value:(_vm.formData.widgetName),callback:function ($$v) {_vm.$set(_vm.formData, "widgetName", $$v)},expression:"formData.widgetName"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"meta信息","prop":"metas"}},[_vm._l((_vm.formData.metas),function(item,index){return [_c('el-row',{staticClass:"meta-item",attrs:{"gutter":5}},[_c('el-col',{attrs:{"span":10}},[_c('el-input',{attrs:{"placeholder":"key只能由字母和_组成"},model:{value:(item.key),callback:function ($$v) {_vm.$set(item, "key", $$v)},expression:"item.key"}})],1),_vm._v(" "),_c('el-col',{attrs:{"span":10}},[_c('el-input',{attrs:{"placeholder":"value"},model:{value:(item.value),callback:function ($$v) {_vm.$set(item, "value", $$v)},expression:"item.value"}})],1),_vm._v(" "),_c('el-col',{attrs:{"span":2}},[_c('el-button',{on:{"click":function($event){_vm.deleteMetaHandler(index)}}},[_vm._v("delete")])],1)],1)]}),_vm._v(" "),_c('el-button',{on:{"click":_vm.addMetaHandler}},[_vm._v("add meta")])],2),_vm._v(" "),_c('el-form-item',{directives:[{name:"show",rawName:"v-show",value:(_vm.formData.resourceType !== _vm.ResourceTypes.pageBuild),expression:"formData.resourceType !== ResourceTypes.pageBuild"}],attrs:{"label":"file","required":""}},[_c('div',{staticClass:"upload-wrapper"},[_c('el-upload',{ref:"upload",staticClass:"upload-container",attrs:{"drag":"","action":"/v1/resources","data":_vm.uploader.data,"headers":_vm.uploader.headers,"on-error":_vm.errorHandler,"on-success":_vm.successHandler,"auto-upload":false}},[_c('i',{staticClass:"el-icon-upload"}),_vm._v(" "),_c('div',{staticClass:"el-upload__text"},[_vm._v("将文件拖到此处，或"),_c('em',[_vm._v("点击上传")])]),_vm._v(" "),_c('div',{staticClass:"el-upload__tip",attrs:{"slot":"tip"},slot:"tip"},[_vm._v("上传文件不超过256MB")])])],1)]),_vm._v(" "),_c('el-form-item',{directives:[{name:"show",rawName:"v-show",value:(_vm.formData.resourceType === _vm.ResourceTypes.pageBuild),expression:"formData.resourceType === ResourceTypes.pageBuild"}],attrs:{"label":"","required":""}},[_c('page-builder',{ref:"pageBuilder"})],1),_vm._v(" "),_c('el-form-item',[_c('el-button',{on:{"click":function($event){_vm.submitUpload('createForm')}}},[_vm._v("创建")])],1)],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
// load the styles
var content = __webpack_require__("fuvk");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("3544f538", content, true);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"page-builder-wrapper"},[_c('h3',[_vm._v("page builder")]),_vm._v(" "),_c('el-dialog',{attrs:{"title":(_vm.currentEditWidget && _vm.currentEditWidget.widgetData.resourceName) + ' widget样式',"visible":_vm.dialogVisible,"size":"tiny"},on:{"update:visible":function($event){_vm.dialogVisible=$event}}},[_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.widgetStyle),expression:"widgetStyle"}],staticClass:"widget-style-editor",attrs:{"rows":"10"},domProps:{"value":(_vm.widgetStyle)},on:{"input":function($event){if($event.target.composing){ return; }_vm.widgetStyle=$event.target.value}}}),_vm._v(" "),_c('div',{staticClass:"dialog-footer",attrs:{"slot":"footer"},slot:"footer"},[_c('el-button',{on:{"click":_vm.hideDialog}},[_vm._v("取 消")]),_vm._v(" "),_c('el-button',{attrs:{"type":"primary"},on:{"click":_vm.updateWidgetHandler}},[_vm._v("确 定")])],1)]),_vm._v(" "),_c('el-row',{staticClass:"js-page-builder",attrs:{"gutter":20}},[_c('el-col',{attrs:{"span":4}},[_c('div',{staticClass:"query-wrapper"},[_c('el-input',{attrs:{"placeholder":"请输入搜索内容"},model:{value:(_vm.queryInput),callback:function ($$v) {_vm.queryInput=$$v},expression:"queryInput"}},[_c('el-button',{attrs:{"slot":"append","icon":"search"},on:{"click":_vm.queryHandler},slot:"append"})],1)],1),_vm._v(" "),_c('el-row',{ref:"leftPanel",staticClass:"widgets-panel",attrs:{"gutter":5}},_vm._l((_vm.widgets),function(widget,index){return _c('el-col',{key:'widget'+index,staticClass:"widget-item js-draggable-widget",attrs:{"span":24,"data-index":index}},[_c('el-popover',{ref:"widgetInfo",refInFor:true,attrs:{"placement":"bottom","width":"400","trigger":"manual"},model:{value:(widget.showInfo),callback:function ($$v) {_vm.$set(widget, "showInfo", $$v)},expression:"widget.showInfo"}},[_c('div',{attrs:{"slot":"reference"},slot:"reference"},[_c('div',{staticClass:"js-widget-wrapper"},[_c('div',{staticClass:"action-panel"},[_c('div',{staticClass:"action-btns"},[_c('i',{staticClass:"el-icon-delete",attrs:{"data-action":"delete"}}),_vm._v(" "),_c('i',{staticClass:"el-icon-edit",attrs:{"data-action":"edit"}})])]),_vm._v(" "),_c('el-card',{staticClass:"js-widget widget-resource",attrs:{"body-style":{padding: 0},"data-index":index},nativeOn:{"mouseleave":function($event){_vm.hideInfoHandler(index)},"mouseenter":function($event){_vm.showInfoHandler(index)}}},[_c('div',{staticStyle:{"padding":"14px"}},[_c('span',[_vm._v(_vm._s(widget.resourceName))])])])],1)]),_vm._v(" "),_vm._t("default",[_c('div',{staticClass:"widget-meta-info"},[_c('ul',_vm._l((widget),function(val,key){return _c('li',[_vm._v("\n                    "+_vm._s(key)+": "+_vm._s(val)+"\n                  ")])}))])])],2)],1)}))],1),_vm._v(" "),_c('el-col',{attrs:{"span":20}},[_c('div',{ref:"rightPanel",staticClass:"page-builder",on:{"click":_vm.widgetActionHandler}})])],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__("nOv4");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cc5d679c_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__("3rce");
function injectStyle (ssrContext) {
  __webpack_require__("nucQ")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-cc5d679c"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cc5d679c_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__("IBlP");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_361bbef4_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__("FGF9");
function injectStyle (ssrContext) {
  __webpack_require__("C5aX")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-361bbef4"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_361bbef4_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__("WZCx");
//
//
//
//
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',[_c('table-view',{staticClass:"resource-list",attrs:{"loader":_vm.loader()}},[_c('el-table-column',{attrs:{"prop":"resourceName","label":"resource name"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"resourceType","align":"center","label":"resource type"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"resourceId","label":"resource ID","width":"350px"}}),_vm._v(" "),_c('el-table-column',{attrs:{"prop":"resourceType","label":"resource status","align":"center","width":"150px"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_vm._v("\n        "+_vm._s(_vm.RESOURCE_STATUS[scope.row.status])+"\n      ")]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"align":"center","label":"resource URL"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('a',{attrs:{"href":scope.row.resourceUrl,"target":"_blank"}},[_vm._v("资源链接")])]}}])}),_vm._v(" "),_c('el-table-column',{attrs:{"label":"","align":"center","width":"200px"},scopedSlots:_vm._u([{key:"default",fn:function(scope){return [_c('el-button',{attrs:{"size":"small"},on:{"click":function($event){_vm.handleEdit(scope.row)}}},[_vm._v("编辑")]),_vm._v(" "),_c('el-button',{directives:[{name:"show",rawName:"v-show",value:(scope.row.status === 1),expression:"scope.row.status === 1"}],attrs:{"size":"small"},on:{"click":function($event){_vm.handlePolicy(scope.row)}}},[_vm._v("创建policy")]),_vm._v(" "),_c('el-button',{directives:[{name:"show",rawName:"v-show",value:(scope.row.status === 2),expression:"scope.row.status === 2"}],attrs:{"size":"small"},on:{"click":function($event){_vm.handlePolicy(scope.row)}}},[_vm._v("修改policy")])]}}])})],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
  ...
  methods: {
    loader: function loader() {
      ...
      return function (param) {
        if ((typeof param === 'undefined' ? 'undefined' : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(param)) === 'object') {
          param = {
            params: param
          };
        }
        return _this.$services.resource.get(param || {});
      };
    },
    handlePolicy: function handlePolicy(resource) {
      this.$router.push({ path: '/resource/policy/create', query: { resourceId: resource.resourceId } });
    },
    handleEdit: function handleEdit(resource) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_draggabilly__ = __webpack_require__("K8K/");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_draggabilly___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_draggabilly__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__resource_types__ = __webpack_require__("3UoX");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    this.queryHandler().then(function () {
      _this.initDraggable();
    });
  },

  methods: {
    setWidgetData: function setWidgetData(widget) {
    ...
    updateWidgetHandler: function updateWidgetHandler() {
    ...
    updateWidgetStyle: function updateWidgetStyle($widget, style) {
      var widgetStyle = {};
      ...
      $widget.widgetStyle = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()($widget.widgetStyle || {}, widgetStyle);
      __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()($widget.style, $widget.widgetStyle);
    },
    object2style: function object2style(widgetStyle) {
      var style = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_entries___default()(widgetStyle || {}).reduce(function (style, entry) {
        return style + (entry[0] + ':' + entry[1] + ';');
      }, '');

      return style;
    },
    transform2Html: function transform2Html() {
      var _this2 = this;
      ...
      $widgets.forEach(function (widget) {
        ...
        if (!widgetName) {
          var errorMsg = '插件widgetName缺失';
          _this2.$message.error(errorMsg);
          throw new Error(errorMsg);
        }
        var style = _this2.object2style(widget.widgetStyle);
        html += '<' + widgetName + '\n                data-widget-src="' + widget.widgetData.resourceId + '"\n                data-widget-config="{}"\n               class="js-wc-widget"\n               style="' + style + '"></' + widgetName + '>';
      });

      return html;
    },
    getPageBuildFile: function getPageBuildFile(filename, mimetype) {
    ...
    getWidgetElement: function getWidgetElement($el) {
    ...
    widgetActionHandler: function widgetActionHandler(event) {
      ...
      var $widget = this.getWidgetElement(target);
      switch (action) {
        case 'delete':
    ...
    editWidget: function editWidget($target) {
    ...
    initDraggable: function initDraggable() {
      var $left = this.$refs.leftPanel.$el;
      var $right = this.$refs.rightPanel;
      var self = this;
      ...
      function initDrag(el, containment) {
        ...
        var revertStyles = function revertStyles() {
          var styles = window.getComputedStyle(_mirror);
          ['top', 'left', 'position'].forEach(function (prop) {
        ...
        el.draggie = new __WEBPACK_IMPORTED_MODULE_2_draggabilly___default.a(el, {
          ...
          if (!event.toElement.contains(el) && event.toElement === $right) {
            ...
            __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()(_copy.style, {
              width: elStyle.width,
    ...
    showInfoHandler: function showInfoHandler(index) {
      this.widgets[index].showInfo = true;
    },
    hideInfoHandler: function hideInfoHandler(index) {
    ...
    queryHandler: function queryHandler() {
      ...
      return this.$services.g_Resources.get({
        params: {
          resourceType: __WEBPACK_IMPORTED_MODULE_3__resource_types__["a" /* default */].widget
        }
      }).then(function (res) {
        var data = res.getData();
        var widgets = data.dataList.filter(function (w) {
          return !!(w && w.systemMeta && w.systemMeta.widgetName);
        });
        _this3.widgets = _this3.widgets.concat(widgets);
      }).catch(function (err) {
        _this3.$message.error(err.response.errorMsg || err);
      });
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__("FJiU");
//
//
//
//
...
// module
exports.push([module.i, ".create-resource-wrapper[data-v-e24cb100]{margin:auto}.meta-item[data-v-e24cb100]{width:400px;margin-bottom:6px}", "", {"version":3,"sources":["/Users/daizecheng/workplace/freelog/console/client/src/views/resource/create/index.vue"],"names":[],"mappings":"AACA,0CAEE,WAAa,CACd,AACD,4BACE,YAAa,AACb,iBAAmB,CACpB","file":"index.vue","sourcesContent":["\n.create-resource-wrapper[data-v-e24cb100] {\n  /*width: 800px;*/\n  margin: auto;\n}\n.meta-item[data-v-e24cb100] {\n  width: 400px;\n  margin-bottom: 6px;\n}\n"],"sourceRoot":""}]);
...
// module
exports.push([module.i, ".resource-list[data-v-12d310b3]{width:100%;min-height:600px}", "", {"version":3,"sources":["/Users/daizecheng/workplace/freelog/console/client/src/views/resource/list/index.vue"],"names":[],"mappings":"AACA,gCACE,WAAY,AACZ,gBAAkB,CACnB","file":"index.vue","sourcesContent":["\n.resource-list[data-v-12d310b3] {\n  width: 100%;\n  min-height: 600px;\n}\n"],"sourceRoot":""}]);
...
// module
exports.push([module.i, ".page-builder .widget-item[data-v-3522a7c0]{position:absolute!important;width:130px}.page-builder .widget-item:hover .action-panel[data-v-3522a7c0]{display:block}.widget-style-editor[data-v-3522a7c0]{width:100%}.action-panel[data-v-3522a7c0]{display:none;position:absolute;top:0;left:0;right:0;bottom:0;background-color:rgba(0,0,0,.5);color:#fff;z-index:9}.action-panel .action-btns[data-v-3522a7c0]{float:right;padding-right:12px}.action-panel .action-btns i[data-v-3522a7c0]{cursor:pointer;margin-right:6px;font-size:16px}.query-wrapper[data-v-3522a7c0]{margin-bottom:15px}.page-builder[data-v-3522a7c0]{width:990px;height:600px;position:relative;border:1px solid #ccc}.widgets-panel[data-v-3522a7c0]{max-height:600px}.widgets-panel .widget-resource[data-v-3522a7c0]{margin-right:10px;margin-bottom:3px;height:100px;overflow:hidden}.widget-resource[data-v-3522a7c0]{cursor:pointer;padding:0}", "", {"version":3,"sources":["/Users/daizecheng/workplace/freelog/console/client/src/views/resource/create/pagebuilder.vue"],"names":[],"mappings":"AACA,4CACE,4BAA8B,AAC9B,WAAa,CACd,AACD,gEACE,aAAe,CAChB,AACD,sCACE,UAAY,CACb,AACD,+BACE,aAAc,AACd,kBAAmB,AACnB,MAAO,AACP,OAAQ,AACR,QAAS,AACT,SAAU,AACV,gCAAqC,AACrC,WAAa,AACb,SAAW,CACZ,AACD,4CACE,YAAa,AACb,kBAAoB,CACrB,AACD,8CACE,eAAgB,AAChB,iBAAkB,AAClB,cAAgB,CACjB,AACD,gCACE,kBAAoB,CACrB,AACD,+BACE,YAAa,AACb,aAAc,AACd,kBAAmB,AACnB,qBAA0B,CAC3B,AACD,gCACE,gBAAkB,CACnB,AACD,iDACE,kBAAmB,AACnB,kBAAmB,AACnB,aAAc,AACd,eAAiB,CAClB,AACD,kCACE,eAAgB,AAChB,SAAW,CACZ","file":"pagebuilder.vue","sourcesContent":["\n.page-builder .widget-item[data-v-3522a7c0] {\n  position: absolute !important;\n  width: 130px;\n}\n.page-builder .widget-item:hover .action-panel[data-v-3522a7c0] {\n  display: block;\n}\n.widget-style-editor[data-v-3522a7c0] {\n  width: 100%;\n}\n.action-panel[data-v-3522a7c0] {\n  display: none;\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(0, 0, 0, 0.5);\n  color: white;\n  z-index: 9;\n}\n.action-panel .action-btns[data-v-3522a7c0] {\n  float: right;\n  padding-right: 12px;\n}\n.action-panel .action-btns i[data-v-3522a7c0] {\n  cursor: pointer;\n  margin-right: 6px;\n  font-size: 16px;\n}\n.query-wrapper[data-v-3522a7c0] {\n  margin-bottom: 15px;\n}\n.page-builder[data-v-3522a7c0] {\n  width: 990px;\n  height: 600px;\n  position: relative;\n  border: 1px solid #cccccc;\n}\n.widgets-panel[data-v-3522a7c0] {\n  max-height: 600px;\n}\n.widgets-panel .widget-resource[data-v-3522a7c0] {\n  margin-right: 10px;\n  margin-bottom: 3px;\n  height: 100px;\n  overflow: hidden;\n}\n.widget-resource[data-v-3522a7c0] {\n  cursor: pointer;\n  padding: 0;\n}\n"],"sourceRoot":""}]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__ = __webpack_require__("cEv/");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e24cb100_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__("MWuU");
function injectStyle (ssrContext) {
  __webpack_require__("L2ZS")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-e24cb100"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e24cb100_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// module
exports.push([module.i, ".resource-detail[data-v-361bbef4]{margin-bottom:15px;text-align:center}.gap[data-v-361bbef4]{margin-bottom:12px}", "", {"version":3,"sources":["/Users/daizecheng/workplace/freelog/console/client/src/views/resource/policy/create/index.vue"],"names":[],"mappings":"AACA,kCACE,mBAAoB,AACpB,iBAAmB,CACpB,AACD,sBACE,kBAAoB,CACrB","file":"index.vue","sourcesContent":["\n.resource-detail[data-v-361bbef4] {\n  margin-bottom: 15px;\n  text-align: center;\n}\n.gap[data-v-361bbef4] {\n  margin-bottom: 12px;\n}\n"],"sourceRoot":""}]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__("+J5m");
//
//
//
//
...
// load the styles
var content = __webpack_require__("IKY7");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("f6d46784", content, true);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__ = __webpack_require__("woOf");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_freelog_policy_compiler__ = __webpack_require__("QtOE");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_freelog_policy_compiler___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_freelog_policy_compiler__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_policy__ = __webpack_require__("/mcc");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    if (resId) {
      this.loadResourceData(resId).then(function (detail) {
        console.log(detail);
        self.resource = detail;
      });
    }
    this.loadPolicyDetail(resId).then(function (policy) {
      if (policy) {
  ...
  methods: {
    loadResourceData: function loadResourceData(param) {
      var _this = this;
    ...
    loadPolicyDetail: function loadPolicyDetail(resId) {
      return this.$services.policy.get(resId).then(function (res) {
        return res.getData();
      });
    },
    validate: function validate() {
      var myBeautify = __WEBPACK_IMPORTED_MODULE_1_freelog_policy_compiler___default.a.compile(this.policyText, 'beautify');
    ...
    createHandler: function createHandler(data) {
      var _this2 = this;

      return this.$services.policy.post(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()({
        ...
        _this2.submitLoading = false;
        _this2.$message.error(err.response.errorMsg || err);
      });
    },
    updateHandler: function updateHandler(data) {
      var _this3 = this;

      return this.$services.policy.put(this.policyDetail.resourceId, data).then(function (res) {
...
// load the styles
var content = __webpack_require__("fv6O");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("597768a2", content, true);
...
//# sourceMappingURL=1.a6c8b2fb89c442536e46.js.map